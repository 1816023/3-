...
bool DeckMng::Init(int deck_type)
{
	DeckMng::deck_type = deck_type;
	deck.resize(4);
	CardLoad();
	DeckLoad();
	return false;
...
CardData DeckMng::Draw()
{
	...
	std::mt19937 mt(rnd());
	std::uniform_int_distribution<> rand_cardsize(0, deck[deck_type].size()-1);
	for (int x = 0; x < 5; x++)
	{
		int a = rand_cardsize(mt);
		hand_vec.push_back(deck[deck_type][a]);
	}
...
void DeckMng::DeckLoad()
{
	//攻撃デッキ
	{
		deck[1].push_back(cardData_map["ヒノキの棒"]);
		deck[1].push_back(cardData_map["高級なヒノキの棒"]);
		deck[1].push_back(cardData_map["伝説のヒノキの棒"]);
		deck[1].push_back(cardData_map["伝説のヒノキの棒"]);
		deck[1].push_back(cardData_map["鉄の大剣"]);
		deck[1].push_back(cardData_map["バスターソード"]);
		deck[1].push_back(cardData_map["バスターソード"]);
		deck[1].push_back(cardData_map["少し飾った槍"]);
		deck[1].push_back(cardData_map["戦闘斧"]);
		deck[1].push_back(cardData_map["如意棒"]);
		deck[1].push_back(cardData_map["爆弾"]);
		deck[1].push_back(cardData_map["爆弾"]);
		deck[1].push_back(cardData_map["髑髏鎌"]);
		deck[1].push_back(cardData_map["ヨーヨー"]);
		deck[1].push_back(cardData_map["緑のスタッフ"]);
		deck[1].push_back(cardData_map["緑のスタッフ"]);
		deck[1].push_back(cardData_map["丸太"]);
		deck[1].push_back(cardData_map["聖なる丸太"]);
		deck[1].push_back(cardData_map["聖なる丸太"]);
		deck[1].push_back(cardData_map["木刀"]);
		deck[1].push_back(cardData_map["火炎剣"]);

		deck[1].push_back(cardData_map["豪華な盾"]);
		deck[1].push_back(cardData_map["貼り付けの盾"]);
		deck[1].push_back(cardData_map["アイアンバックラー"]);		
		deck[1].push_back(cardData_map["ゴールドバックラー"]);
		deck[1].push_back(cardData_map["バケツメット"]);
		deck[1].push_back(cardData_map["騎士の鎧"]);
		deck[1].push_back(cardData_map["霞の王の盾"]);
		deck[1].push_back(cardData_map["王者の盾"]);

		deck[1].push_back(cardData_map["回復の薬"]);
		deck[1].push_back(cardData_map["回復の薬・改"]);
		deck[1].push_back(cardData_map["回復の薬・改"]);
		deck[1].push_back(cardData_map["回復の薬・真"]);
		deck[1].push_back(cardData_map["回復の薬・真"]);
		deck[1].push_back(cardData_map["回復の薬・真"]);
		deck[1].push_back(cardData_map["狂化の丸薬"]);
		deck[1].push_back(cardData_map["狂化の丸薬・改"]);
		deck[1].push_back(cardData_map["狂化の丸薬・真"]);
		deck[1].push_back(cardData_map["狂化の丸薬・真"]);
		deck[1].push_back(cardData_map["硬化のオイル"]);
		deck[1].push_back(cardData_map["硬化のオイル・改"]);
	}

	//防御デッキ
	{
		deck[2].push_back(cardData_map["ヒノキの棒"]);
		deck[2].push_back(cardData_map["高級なヒノキの棒"]);
		deck[2].push_back(cardData_map["伝説のヒノキの棒"]);
		deck[2].push_back(cardData_map["バスターソード"]);
		deck[2].push_back(cardData_map["少し飾った槍"]);
		deck[2].push_back(cardData_map["戦闘斧"]);
		deck[2].push_back(cardData_map["如意棒"]);
		deck[2].push_back(cardData_map["髑髏鎌"]);
		deck[2].push_back(cardData_map["緑のスタッフ"]);
		deck[2].push_back(cardData_map["火炎剣"]);

		deck[2].push_back(cardData_map["木の盾"]);
		deck[2].push_back(cardData_map["豪華な盾"]);
		deck[2].push_back(cardData_map["大き目な木の盾"]);
		deck[2].push_back(cardData_map["大き目な木の盾"]);
		deck[2].push_back(cardData_map["貼り付けの盾"]);
		deck[2].push_back(cardData_map["貼り付けの盾"]);
		deck[2].push_back(cardData_map["アイアンバックラー"]);
		deck[2].push_back(cardData_map["アイアンバックラー"]);
		deck[2].push_back(cardData_map["ゴールドバックラー"]);
		deck[2].push_back(cardData_map["バケツメット"]);
		deck[2].push_back(cardData_map["レザーアーマー"]);
		deck[2].push_back(cardData_map["騎士の鎧"]);
		deck[2].push_back(cardData_map["騎士の鎧"]);
		deck[2].push_back(cardData_map["翡翠の盾"]);
		deck[2].push_back(cardData_map["翡翠の盾"]);
		deck[2].push_back(cardData_map["霞の王の盾"]);
		deck[2].push_back(cardData_map["霞の王の盾"]);
		deck[2].push_back(cardData_map["王者の盾"]);
		deck[2].push_back(cardData_map["王者の盾"]);

		deck[2].push_back(cardData_map["回復の薬"]);
		deck[2].push_back(cardData_map["回復の薬"]);
		deck[2].push_back(cardData_map["回復の薬・改"]);
		deck[2].push_back(cardData_map["回復の薬・改"]);
		deck[2].push_back(cardData_map["回復の薬・真"]);
		deck[2].push_back(cardData_map["狂化の丸薬"]);
		deck[2].push_back(cardData_map["硬化のオイル"]);
		deck[2].push_back(cardData_map["硬化のオイル・改"]);
		deck[2].push_back(cardData_map["硬化のオイル・改"]);
		deck[2].push_back(cardData_map["硬化のオイル・真"]);
		deck[2].push_back(cardData_map["硬化のオイル・真"]);
	}

	//バランスデッキ
	{
		deck[3].push_back(cardData_map["ヒノキの棒"]);
		deck[3].push_back(cardData_map["高級なヒノキの棒"]);
		deck[3].push_back(cardData_map["伝説のヒノキの棒"]);
		deck[3].push_back(cardData_map["訓練用の木剣"]);
		deck[3].push_back(cardData_map["鉄の大剣"]);
		deck[3].push_back(cardData_map["バスターソード"]);
		deck[3].push_back(cardData_map["少し飾った槍"]);
		deck[3].push_back(cardData_map["戦闘斧"]);
		deck[3].push_back(cardData_map["如意棒"]);
		deck[3].push_back(cardData_map["爆弾"]);
		deck[3].push_back(cardData_map["髑髏鎌"]);
		deck[3].push_back(cardData_map["ヨーヨー"]);
		deck[3].push_back(cardData_map["緑のスタッフ"]);
		deck[3].push_back(cardData_map["丸太"]);
		deck[3].push_back(cardData_map["聖なる丸太"]);
		deck[3].push_back(cardData_map["木刀"]);
		deck[3].push_back(cardData_map["火炎剣"]);

		deck[3].push_back(cardData_map["木の盾"]);
		deck[3].push_back(cardData_map["豪華な盾"]);
		deck[3].push_back(cardData_map["大き目な木の盾"]);
		deck[3].push_back(cardData_map["貼り付けの盾"]);
		deck[3].push_back(cardData_map["アイアンバックラー"]);
		deck[3].push_back(cardData_map["ゴールドバックラー"]);
		deck[3].push_back(cardData_map["バケツメット"]);
		deck[3].push_back(cardData_map["レザーアーマー"]);
		deck[3].push_back(cardData_map["騎士の鎧"]);
		deck[3].push_back(cardData_map["翡翠の盾"]);
		deck[3].push_back(cardData_map["霞の王の盾"]);
		deck[3].push_back(cardData_map["王者の盾"]);

		deck[3].push_back(cardData_map["回復の薬"]);
		deck[3].push_back(cardData_map["回復の薬"]);
		deck[3].push_back(cardData_map["回復の薬・改"]);
		deck[3].push_back(cardData_map["回復の薬・改"]);
		deck[3].push_back(cardData_map["回復の薬・真"]);
		deck[3].push_back(cardData_map["狂化の丸薬"]);
		deck[3].push_back(cardData_map["狂化の丸薬・改"]);
		deck[3].push_back(cardData_map["狂化の丸薬・真"]);
		deck[3].push_back(cardData_map["硬化のオイル"]);
		deck[3].push_back(cardData_map["硬化のオイル・改"]);
		deck[3].push_back(cardData_map["硬化のオイル・真"]);
	}
}
